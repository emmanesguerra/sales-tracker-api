...
class QRCodeServiceTest extends TestCase
{
    ...
    public function testGeneratesQRCodeHtmlCorrectly()
    {
        ...
        $htmlOutput = $this->invokeMethod($this->qrCodeService, 'generateQrCodesHtml', [$items]);
    ...
    public function testCreatesAPdfFile()
    {
        ...
        $pdfFilePath = $this->invokeMethod($this->qrCodeService, 'createPdf', [$htmlQrList]);
    ...
    public function testHandlesPdfGenerationAndDownload()
    {
        ...
        $response = $this->qrCodeService->generateQRCodeForPdf([1]);

        // Step 5: Assert response was returned and headers are correct
